              ...
              <el-form-item label="" :prop="`orderList.${scope.$index}.consigneeName`" :rules="rules.orderList.consigneeName">
                ...
                >
                  <el-input
                      ...
                      @paste.native="e => { debounceSearch(e, scope.row, 'paste') }"
                      @keyup.native="e => { debounceSearch(e, scope.row, 'keyup') }"
                  ></el-input>
                  <Member
                      :members="members"
...
export default {
  ...
  methods: {
    ...
    async enterRemark (index) {
      console.log("enterRemark -> index", index)
    ...
    debounceSearch (event, row) {
      console.log("debounceSearch -> event.keyCode", event.keyCode)
      // debugger
    ...
    async memberSearch (row) {
      ...
      if (
        ...
        console.log("memberSearch -> row.consigneeName", row.consigneeName)
        // 搜索
